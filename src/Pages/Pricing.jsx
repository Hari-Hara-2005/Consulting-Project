...
function PricingCard({ highlighted = false }) {
  return (
    <div
      className="rounded-2xl border p-8 flex flex-col sm:flex-row sm:items-center gap-8"
      style={
        highlighted
    ...
    >
      ...
      <div className="sm:w-56 shrink-0">
        <p
          ...
          style={{ color: highlighted ? THEME.secondary : THEME.primary }}
        >
          Basic Package
        </p>
        <p
          className="text-6xl font-extrabold leading-none mb-6"
          style={{ color: highlighted ? "#ffffff" : THEME.primary }}
        >
          $199
          <span
            className="text-base font-medium align-baseline ml-1"
            style={{ color: highlighted ? "#cbd5c9" : "#64748b" }}
          >
            /month
          </span>
        </p>
        <a
          href="#"
          className="inline-flex items-center gap-1.5 font-semibold text-sm transition-opacity hover:opacity-80"
        ...
        {FEATURES.map(([left, right], i) => (
          <React.Fragment key={i}>
            <div className="flex items-center gap-2.5">
              ...
              <span style={{ color: highlighted ? "#ffffff" : THEME.primary }}>
                {left}
              </span>
            </div>
            <div className="flex items-center gap-2.5">
  ...
  return (
    <>
      <PageTitleBanner
        ...
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Pricing Plan", href: "#", active: true },
        ]}
      />
      <section className="bg-white py-20 px-6 md:px-16">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[420px_1fr] gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-20">
            ...
            <button
              className="font-bold text-sm tracking-wide px-7 py-4 rounded-lg text-white transition-opacity hover:opacity-90"
